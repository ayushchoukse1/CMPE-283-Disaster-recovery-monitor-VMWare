...
public class VmCdOpWin {
		...
		if ("add".equalsIgnoreCase(op)) {
			...
			String iso = "7601.17514.101119-1850_x64fre_server_eval_en-us-GRMSXEVAL_EN_DVD";
	...
	static VirtualDeviceConfigSpec createAddCdConfigSpec(VirtualMachine vm,
		...
		cdDeviceBacking
				.setFileName("[nf3team11] __DEPLOY__/ESXI_HOST_FILES/iso-win/Windows_Server_2008_R2_SPI_WG_Apr-5-2012/7601.17514.101119-1850_x64fre_server_eval_en-us-GRMSXEVAL_EN_DVD.iso");
